...
--
  ...
  (CLA_RAZON_SOCIAL, CLA_EMPRESA,       CLA_TRAB,      NOM_TRAB,
   ...
   Select Distinct b.CLA_RAZON_SOCIAL, b.CLA_EMPRESA, b.CLA_TRAB,
          ...
          FECHA_ING_GRUPO,  Isnull(FECHA_BAJA, @w_fechaTerminoPTU),  b.STATUS_TRAB, b.CLA_PUESTO,
          e.CLA_CENTRO_COSTO, b.CLA_CLASIFICACION, d.CLA_UBICACION,  f.CLA_AREA,
          b.CLA_DEPTO,        b.SUELDO_DIA
   From   dbo.RH_Trab        b
   Join   #TmpEmpresa        c
   On     c.CLA_EMPRESA      = b.CLA_EMPRESA
   ...
   Join   dbo.RH_PTU         g
   On     g.CLA_EMPRESA      = b.CLA_EMPRESA
   And    g.CLA_TRAB         = b.CLA_TRAB
   Where  b.FECHA_ING_GRUPO <= @w_fechaTerminoPTU
   And    b.aplica_ptu       = 1
   And   (b.STATUS_TRAB      = 'A'
   Or    (b.STATUS_TRAB      = 'B'
   And    b.FECHA_BAJA      >= @w_fechaInicioPTU))
   Order  By 1, 2, 3;
